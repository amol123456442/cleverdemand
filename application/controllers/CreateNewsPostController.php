...
class CreateNewsPostController extends CI_Controller
{
        ...
        try {
            ...
            if ($id) {
                ...
                if (!$data['post'] || $data['post']['user_id'] != $user_id) {
                    $this->session->set_flashdata('error', 'News post not found or unauthorized.');
                    redirect('createpost');
                }
            } else {
                $data['post'] = null;
    ...
    public function store()
    {
        ...
        if ($this->CreateNewsPostModel->insert($data)) {
            ...
            $this->session->set_flashdata('error', 'Failed to create news post. Please try again.');
        }
    ...
    {
        // same as pressrelease update logic
    }

    // Delete news post
    public function delete($id)
    {
        // same as pressrelease delete logic
    }
