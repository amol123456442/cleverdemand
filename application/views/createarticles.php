      ...
      <div class="container my-5">
        <div class="card">
            <div class="card-header">
                <h4 class="text-center"><?= isset($post) ? "Edit Articles" : "Create Articles" ?></h4>
            </div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <?php
                $formAction = isset($post) ? base_url('CreateArticlesController/update/' . $post['id']) : base_url('CreateArticlesController/store');
                ?>
                <form action="<?= $formAction ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="title" id="title"
                            value="<?= isset($post) ? htmlspecialchars($post['title']) : '' ?>" required onkeyup="generateSlug()" placeholder="Enter press release title">
                    </div>
                    <div class="mb-4">
                        ...
                        <small class="text-muted">This will be used in the URL for the press release</small>
                    </div>
  <div class="mb-4">
                    ...
                    <!-- Category, Provided By, Image Upload, Content (unchanged) -->
                    ...
                    <div class="d-grid mt-4">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="fas fa-save me-2"></i><?= isset($post) ? "Update Articles" : "Create Articles" ?>
                        </button>
                    </div>
                </form>
